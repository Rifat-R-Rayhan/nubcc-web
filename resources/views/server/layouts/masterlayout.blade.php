                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <div class="mt-4">
                                <img src="../backend/assets/img/icons/nubcc_logo.png" alt="girl-doing-yoga-light" width="140" class="img-fluid" data-app-dark-img="illustrations/girl-doing-yoga-dark.png" data-app-light-img="illustrations/girl-doing-yoga-light.png" />
                            </div>
                        </span>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Account Settings">Homepage</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                                    <div data-i18n="Notifications">Slider</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                                    <div datpages-account-settings-connections.htmla-i18n="Connections">Courses</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                                    <div data-i18n="Connections">Upcoming Plans</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                                    <div data-i18n="Connections">Footer</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link" target="_blank">
                                    <div data-i18n="Basic">Image</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link" target="_blank">
                                    <div data-i18n="Basic">Content</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                                    <div data-i18n="Error">New Event</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{'maintenance'}}" class="menu-link">
                                    <div data-i18n="Under Maintenance">Event List</div>
                                </a>
                            </li>
                    ...
                    <!-- Components -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Administrative</span></li>
                    <!-- Cards -->
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="{{route('tshirts')}}" class="menu-link">
                            <i class="fa-solid fa-shirt me-3"></i>
                            <div data-i18n="Under Maintenance">T-Shirt Transaction</div>
                        </a>
                    </li>


                    <!-- Forms & Tables -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Setting &amp; Privacy</span></li>
                    ...
                    <li class="menu-item">
                        <a href="{{'maintenance'}}" class="menu-link">
                            ...
                            <div data-i18n="Basic">General Setting</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{'maintenance'}}" class="menu-link">
                    ...
                    <!-- Misc -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Terms & Conditions</span></li>

                    <li class="menu-item">
                        <a href="{{'maintenance'}}" class="menu-link">
                            <i class="fa-solid fa-building-shield me-3"></i>
                            <div data-i18n="Basic">License & Policies</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{'maintenance'}}" class="menu-link">
                            <i class="fa-solid fa-circle-question me-3"></i>
                            <div data-i18n="Basic">Help</div>
                        </a>
                    </li>
