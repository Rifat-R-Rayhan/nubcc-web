	...
	<!-- START REVOLUTION SLIDER 5.4.1 fullscreen mode -->
		...
		<!-- SLIDE 2 -->
			<li data-index="rs-84" data-transition="fade" data-slotamount="default" 
				...
				<!-- MAIN IMAGE -->
				<img src="assets/img/NUB_admission (1).jpg"  alt=""  data-bgposition="center center" 
				...
				<div class="tp-caption tp-resizeme" 
					...
					style="z-index: 13; white-space: nowrap;  line-height: 90px; font-weight: 600; 
					color: rgb(3, 3, 37); ">Admission Going On<br>
					Spring 2024
				</div>
				...
				<div class="tp-caption tp-resizeme visit-btn" 
					...
					style="z-index: 15; white-space: nowrap; font-size: 20px; line-height: 30px; color: rgb(3, 3, 37); 
					border-color:rgb(3, 3, 37); border-style:solid;border-width:0px 0px 3px 0px;cursor:pointer;
					letter-spacing: 5px; font-weight: 600; min-width: auto; margin-top:160px;">Department of Computer Science and Engineering </div>
			...
			<li data-index="rs-82" data-transition="fade" data-slotamount="default" 
				...
				data-slicey_shadow="0px 0px 50px 0px transparent">
				<!-- MAIN IMAGE -->
				<img src="assets/img/n4.jpeg"  alt=""  data-bgposition="center center" 
					data-kenburns="on" data-duration="7000" data-ease="Linear.easeNone" 
					data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" 
					data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" 
					class="rev-slidebg" data-no-retina>
				...
				<div class="tp-caption tp-resizeme" 
					...
					style="z-index: 14; white-space: nowrap; line-height: 90px; font-weight: 600; 
					color: rgb(3, 3, 37);">Welcome to <span>NUBCC</span></div>
				...
				<div class="tp-caption tp-resizeme visit-btn" 
					...
					style="z-index: 15; white-space: nowrap; font-size: 25px; line-height: 30px; color: rgb(3, 3, 37); 
					border-color:rgb(3, 3, 37); border-style:solid;border-width:0px 0px 3px 0px;cursor:pointer;
					letter-spacing: 5px; font-weight: 600; min-width: auto;;">Most prestigious and largest club on campus. </div>
			...
			<li data-index="rs-84" data-transition="fade" data-slotamount="default" 
				...
				data-slicey_shadow="0px 0px 50px 0px transparent">
				<!-- MAIN IMAGE -->
				<img src="assets/img/n5.jpeg"  alt=""  data-bgposition="center center" 
					data-kenburns="on" data-duration="7000" data-ease="Linear.easeNone" 
					data-scalestart="100" data-scaleend="150" data-rotatestart="0" data-rotateend="0" 
					data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" 
					class="rev-slidebg" data-no-retina>
				...
				<div class="tp-caption tp-resizeme" 
					...
					style="z-index: 14; white-space: nowrap;  line-height: 90px; font-weight: 600; 
					color: rgb(3, 3, 37); ">Innovative Events</div>
				...
				<div class="tp-caption tp-resizeme visit-btn" 
					...
					style="z-index: 15; white-space: nowrap; font-size: 20px; line-height: 30px; color: rgb(3, 3, 37); 
					border-color:rgb(3, 3, 37); border-style:solid;border-width:0px 0px 3px 0px;cursor:pointer;
					letter-spacing: 5px; font-weight: 600; min-width: auto;">NUBCC's calendar is packed with engaging events. </div>
			...
			<li data-index="rs-85" data-transition="fade" data-slotamount="default" data-hideafterloop="0" 
				...
				<!-- MAIN IMAGE -->
				<img src="assets/img/about.jpg"  alt=""  data-bgposition="center center" data-kenburns="on"
				...
				<div class="tp-caption tp-resizeme"  
					...
					style="z-index: 14; white-space: nowrap;  line-height: 90px; font-weight: 600; 
					color: white; ">A Nexus of Learning</div>
				...
				<div class="tp-caption tp-resizeme visit-btn" 
					...
					style="z-index: 15; white-space: nowrap; font-size: 25px; line-height: 30px; color: white; 
					border-color:white; border-style:solid;border-width:0px 0px 3px 0px;cursor:pointer;
					letter-spacing: 5px; font-weight: 600; min-width: auto;">We are immersed in a world of continuous learning. </div>
